...
export { default as Weapons } from './sidebar-components/Weapons'
export { default as Armour } from './sidebar-components/Armour'
export { default as Gadget } from './sidebar-components/Gadget'
